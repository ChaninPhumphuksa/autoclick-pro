...
DEFAULT_CONFIG = {
    ...
    "play_sound_on_complete": True,       # เล่นเสียงแจ้งเตือนเมื่อทำงานเสร็จตามจำนวน/รอบที่ตั้งไว้
    "position_jitter_pixels": 0,          # สุ่มตำแหน่งคลิกในรัศมีกี่พิกเซล (0 = ปิด)
    "input_backend": "pyautogui",         # "pyautogui" (ปกติ) หรือ "directinput" (เข้ากันได้กับเกม)
}
