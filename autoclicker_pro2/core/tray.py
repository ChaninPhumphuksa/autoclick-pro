...
class TrayIcon:
    ...
    def _build_menu(self):
        return pystray.Menu(
            pystray.MenuItem("แสดงหน้าต่างโปรแกรม", lambda: self.on_show(), default=True),
            pystray.Menu.SEPARATOR,
            pystray.MenuItem("เริ่ม/หยุด Auto Click", lambda: self.on_toggle_click()),
            pystray.MenuItem("เริ่ม/หยุด เล่นมาโคร", lambda: self.on_toggle_play()),
            pystray.Menu.SEPARATOR,
            pystray.MenuItem("⛔ หยุดทั้งหมด", lambda: self.on_stop_all()),
            pystray.Menu.SEPARATOR,
    ...
    def start(self):
        ...
        try:
            ...
            return
        self._icon = pystray.Icon("AutoClickerPro", image, "Auto Clicker Pro", self._build_menu())
